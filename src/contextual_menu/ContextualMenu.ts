...
export default class ContextualMenu extends AbstractElement implements IElement {

  protected _relative?: HTMLElement

  protected _relativePosition?: ContextualMenuPosition
  ...
  constructor(relative?: HTMLElement, relativePosition?: ContextualMenuPosition, children?: IElement[]) {
    const element = document.createElement("div")
    super(element)

    this._relative = relative
    this._relativePosition = relativePosition ?? ContextualMenuPosition.BottomLeft
  ...
  public get x(): number {
    ...
    switch (this._relativePosition) {
      case ContextualMenuPosition.BottomLeft:
      default: {
        x = rect.x
      }
    }
